...
class Product(models.Model):
    ...
    product_image1_alt = models.CharField(max_length=255, blank=True)
    product_image2 = models.ImageField(upload_to='product_images/', blank=True, null=True)
    product_image2_alt = models.CharField(max_length=255, blank=True)
    product_image3 = models.ImageField(upload_to='product_images/', blank=True, null=True)
    product_image3_alt = models.CharField(max_length=255, blank=True)
    product_image4 = models.ImageField(upload_to='product_images/', blank=True, null=True)
    product_image4_alt = models.CharField(max_length=255, blank=True)
    product_image5 = models.ImageField(upload_to='product_images/', blank=True, null=True)
    product_image5_alt = models.CharField(max_length=255, blank=True)
    product_moq = models.PositiveIntegerField(default=1, blank=True, null=True)
    product_trusted_icon1 = models.ImageField(upload_to='trusted_icons/', blank=True, null=True)
    product_trusted_text1 = models.CharField(max_length=255, blank=True)
    product_trusted_icon2 = models.ImageField(upload_to='trusted_icons/', blank=True, null=True)
    product_trusted_text2 = models.CharField(max_length=255, blank=True)
    product_trusted_icon3 = models.ImageField(upload_to='trusted_icons/', blank=True, null=True)
    product_trusted_text3 = models.CharField(max_length=255, blank=True)
    product_trusted_icon4 = models.ImageField(upload_to='trusted_icons/', blank=True, null=True)
    product_trusted_text4 = models.CharField(max_length=255, blank=True)
